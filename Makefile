...
PROJECTNAME = gecko_test
ARM_GCC_DIR_WIN = 
ARM_GCC_DIR_OSX = 
ARM_GCC_DIR_LINUX = ../../developer/toolchains/gnu_arm/10.3_2021.10
POST_BUILD_EXE_WIN = 
POST_BUILD_EXE_OSX = 
POST_BUILD_EXE_LINUX = ../../developer/adapter_packs/commander/commander
